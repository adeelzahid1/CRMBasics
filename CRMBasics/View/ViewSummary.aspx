<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSummary.aspx.cs" Inherits="CRMBasics.View.ViewSummary" %>
...
<body>
            ...
            <div id="tableInfo">
                <div class="container-fluid">
                    <div class="row mt-1">
                        ...
                        <tbody id="compnayKO" data-bind="foreach: viewModel.summary"> <%--data-bind="foreach: {data: Accounts, as:'Account'}--%><%--data-bind="foreach: Accounts"--%>
                            <tr>
    ...
    <script src="../Script/viewSummary.js"></script>
    <script>
