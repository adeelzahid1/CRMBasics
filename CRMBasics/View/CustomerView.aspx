<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerView.aspx.cs" Inherits="CRMBasics.View.CustomerView" %>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-10 offset-2 m-auto">
                            <div class="col-8 offset-4 m-auto p-3">
                                <h2 class="text-danger">Details About Your Selecte View </h2>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:DropDownList ID="DropDownListCards" runat="server" CssClass="form-control" ><%--enable: selectedChoice"--%><%--data-bind="value: selectedValue, optionsText:???"--%>
                                ...
                                <div class="col-sm-5">
                                    <input type="text" id="search" class="form-control-sm ml-2"  placeholder="Search..."/> <%--data-bind="value: viewModel.searchTxt, valueUpdate: 'afterkeydown'"--%>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row mt-1">
                        ...
                        <div class="col-12 m-auto">
                           ...
                           <table class="table table-hover pl-lg-5 table-responsive" id="customerTable">
                        ...
                        <tbody id="ttt" data-bind="foreach: vm.customers"> <%--data-bind="foreach: {data: Accounts, as:'Account'}--%><%--data-bind="foreach: Accounts"--%>
                            <tr>
    ...
    <script src="../Script/CustomerView.js"></script>
    <script>
